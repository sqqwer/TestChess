...
std::vector<DoublePair>		Queens::GetPossitionToGo(
...
bool Queens::FindTurn(std::vector<DoublePair>& ObjectVector, DoublePair i)
{
	bool EBV;
	bool Side = this->Side;
	int h = 30, w = 30;
...
std::vector<DoublePair> Queens::CanAttack()
{
	std::vector<DoublePair> Buffer;
...
std::vector<DoublePair> Queens::CanMove(DoublePair Map[8][8], DoublePair Poss)
{
	std::vector<DoublePair> Buffer;
